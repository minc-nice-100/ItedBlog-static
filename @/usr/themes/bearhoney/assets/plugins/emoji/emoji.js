...
(function($){
	...
	$('.emoemo').append('<div class="emotions"></div>');
			...
			$('.emotions').html('<div style="float:right;"><a href="javascript:void(0);" id="sync"><i class="sync icon"></i></a><a href="javascript:void(0);" id="prev">&laquo;</a><a href="javascript:void(0);" id="next">&raquo;</a></div><div class="categorys"></div><div class="container"></div><div class="page"></div>');
		...
		function showEmotions(){
			...
			for(var i = page * 72; i < (page + 1) * 72 && i < emotions[category].length; ++i){
			   ...
			   $('.emotions .container').append($('<a style="margin-left:5px;margin-bottom:5px;width:auto;height:auto" href="javascript:void(0);" title="' + emotions[category][i].name + '"><span>' +emotions[category][i].name + ' </span></a>'));     
				...
				$('.emotions .container').append($('<a href="javascript:void(0);" title="' + emotions[category][i].name + '"><img src="' + emotions[category][i].icon + '" alt="' + emotions[category][i].text + '" width="22" height="22" loading="lazy" /></a>'));
			...
			$('.emotions .container a').click(function(){
				...
				$("#friendcircle-comment-container").attr("style", "box-shadow: inset 0px 0px 0px 1px var(--bearhoney-accent-color);");
